...
func newKarrotCloudRunService(ctx *pulumi.Context, project *organizations.Project) (*cloudrun.Service, error) {
	serviceName := "karrot"
					...
					cloudrun.ServiceTemplateSpecContainerArgs{
						...
						Ports: cloudrun.ServiceTemplateSpecContainerPortArray{
							cloudrun.ServiceTemplateSpecContainerPortArgs{
								...
								ContainerPort: pulumi.Int(18080),
							},
						},
	...
	_, err = cloudrun.NewDomainMapping(ctx, "karrot-staging-taehoio", &cloudrun.DomainMappingArgs{
		Project:  project.ProjectId,
		Location: pulumi.String(iac.TokyoLocation),
